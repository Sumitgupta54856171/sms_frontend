...
import { uploadTeacherPhoto, fetchTeacherPhoto, getTeacherPhotoBlobUrl, deleteTeacherPhoto } from "@/api/teacher";
...
export default function TeacherPhotoUpload({ teacherName, teacherId }: TeacherPhotoUploadProps) {
  ...
  const handleRemove = async () => {
    if (!teacherId) return;
    try {
      await deleteTeacherPhoto(teacherId);
      setPhoto(null);
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="relative">
            <Avatar className="h-40 w-40 border-4 border-slate-100 shadow-md">
              {isLoading ? (
                ...
                <AvatarImage src={photo} alt="Teacher photo" className="object-cover" />
              ) : (
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            />
            <label htmlFor="teacher-photo-upload">
              <Button
                type="button"
                variant="outline"
