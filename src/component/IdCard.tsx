...
export default function IdCard({ student, principalName = "Dr. Sharma" }: IDCardProps) {
  ...
  return (
    <div
      className="id-card bg-white rounded-sm overflow-hidden border border-slate-300 flex flex-col relative print:border-slate-400 print:shadow-none shadow-md"
    ...
    >
      ...
      {/* ─── HEADER ─── */}
      <div className="relative shrink-0 z-10 bg-white" style={{ height: "15mm" }}>
        <div
          className="absolute top-0 left-0 w-full z-10"
          style={{ height: "13mm", backgroundColor: "#1a2b4c", clipPath: "polygon(0 0, 100% 0, 100% 50%, 0 100%)" }}
        />
        ...
        <div className="absolute top-0 left-0 w-full h-full z-20 flex items-start px-[2mm] pt-[1.5mm]">
          ...
          <div className="ml-[1.5mm] flex flex-col justify-start">
            ...
            <h2 className="text-[8.5pt] font-bold text-white/90 font-serif tracking-[0.15em] leading-tight">
              HIGH SCHOOL
            </h2>
            <p className="text-[7pt] text-white/80 font-medium tracking-wide leading-tight">
        ...
        <div className="absolute bottom-[0.5mm] left-0 w-full flex justify-center z-30">
          <div className="bg-white text-[#1a2b4c] text-[7pt] font-bold uppercase tracking-[0.1em] px-[2mm] py-[0.3mm] rounded-full border border-slate-200 shadow-sm">
      ...
      <div className="flex-1 flex flex-col items-center px-[2mm] pt-[1mm] pb-[4mm] z-10 w-full overflow-hidden">
        ...
        <div className="flex flex-col items-center w-full">
          <div
            ...
            style={{ width: "15mm", height: "18mm" }}
          >
            {photoUrl ? (
              <img src={photoUrl} alt="" className="w-full h-full object-cover rounded-sm" />
            ) : (
              <div className="w-full h-full flex items-center justify-center bg-slate-100 text-slate-400 text-[7pt] font-bold rounded-sm">
                NO PHOTO
              </div>
            )}
          </div>
          ...
          {/* Student Name */}
          <h3 className="mt-[0.5mm] text-[11pt] font-extrabold text-[#1a2b4c] uppercase tracking-wide font-serif text-center leading-tight w-full truncate">
            {student.name}
          </h3>

          {/* Scholar No badge */}
          <div className="mt-[0.5mm] bg-[#1a2b4c]/5 px-[1.5mm] py-[0.2mm] rounded-full">
            <p className="text-[8pt] text-[#1a2b4c] font-bold tracking-wide">
        ...
        {/* Divider */}
        <div className="w-full mt-[1.2mm] mb-[0.8mm] flex items-center gap-[1mm] px-[0.5mm]">
        ...
        <div className="w-full space-y-[1mm] font-sans">
          <div className="flex text-[9pt] items-baseline">
            <span className="w-[17mm] shrink-0 text-slate-600 font-semibold">Father's Name</span>
            <span className="w-[1.5mm] shrink-0 text-slate-400 font-bold text-center">:</span>
            <span className="flex-1 font-bold text-slate-900 text-[9pt] leading-snug truncate">
              {student.father_name || "—"}
            </span>
          </div>

          <div className="flex text-[9pt] items-baseline">
            <span className="w-[17mm] shrink-0 text-slate-600 font-semibold">Class / Sec.</span>
            <span className="w-[1.5mm] shrink-0 text-slate-400 font-bold text-center">:</span>
            <span className="flex-1 font-bold text-slate-900 text-[9pt] leading-snug">
              {student.classInfo ? formatClassWithSuffix(student.classInfo) : "—"}
            </span>
          </div>

          <div className="flex text-[9pt] items-baseline">
            <span className="w-[17mm] shrink-0 text-slate-600 font-semibold">City</span>
            <span className="w-[1.5mm] shrink-0 text-slate-400 font-bold text-center">:</span>
            <span className="flex-1 font-bold text-slate-900 text-[9pt] leading-snug">
              Satna (M.P.)
            </span>
      ...
      <div className="absolute bottom-[1.5mm] right-[2mm] z-20">
        <div className="flex flex-col items-center">
          ...
          <div className="text-[7pt] font-bold text-[#1a2b4c] border-t-[1px] border-[#1a2b4c] pt-[0.3mm] px-[1mm] uppercase tracking-widest">
            Principal
          </div>
        </div>
      </div>
